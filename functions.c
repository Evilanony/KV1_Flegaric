...
int unos_ne_gaziranog(struct sokovi* sok) {
	...
	printf("___________________________________________________\n");
	printf("uneseni ne gazirani sok je %s", sok->ne_gazirano.naziv_ne_gazirano);
	printf("___________________________________________________\n");
...
int unos_kave_obicne(struct kava* kava) {
	...
	printf("___________________________________________________\n");
	printf("unesena kava je %s", kava->obicna.naziv_obicna);
	printf("___________________________________________________\n");
	printf("cijena kave je %fkn\n", kava->obicna.cijena_obicna);
	printf("___________________________________________________\n");
	...
	printf("___________________________________________________\n");
	printf("uneseni cappucino je %s", kava->cappucino.naziv_cappucino);
	printf("___________________________________________________\n");
	...
	printf("___________________________________________________\n");
	printf("uneseni alkohol je %s", alkohol->obicni.naziv_obicni);
	printf("___________________________________________________\n");
	...
	printf("___________________________________________________\n");
	printf("uneseni alkohol je %s", alkohol->zestoko.naziv_zestoko);
	printf("___________________________________________________\n");
